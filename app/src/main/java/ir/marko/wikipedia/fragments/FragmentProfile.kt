...
import ir.marko.wikipedia.adapters.ProfileAdapter
...
class FragmentProfile() : Fragment() , ItemEvents {
    ...
    private fun defaultConfig() {
        ...
        val myAdapter = ProfileAdapter(data.clone() as ArrayList<ItemInfo> , this)
        binding.recyclerProfile.adapter = myAdapter
